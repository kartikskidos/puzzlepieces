...
{
    if (shakeAmount === undefined) shakeAmount = 3;
    if (delay === undefined) delay = 0;
    if (shakeLength === undefined) shakeLength = ScenesTransitions.TRANSITION_LENGTH;
    if (callbackOnComplete === undefined) callbackOnComplete = null;
    if (callbackOnUpdate === undefined) callbackOnUpdate = null;
...
{
    if (delay === undefined) delay = 0;
    if (transitionLength === undefined) transitionLength = ScenesTransitions.TRANSITION_LENGTH / 2;
    if (callback === undefined) callback = null;
    if (toAlpha === undefined) toAlpha = 1;

    transitionLength = transitionLength / getCpuSpeedMul();
    delay = delay / getCpuSpeedMul();
...
{
    if (delay === undefined) delay = 0;
    if (transitionLength === undefined) transitionLength = ScenesTransitions.TRANSITION_LENGTH;
    if (callback === undefined) callback = null;
...
ScenesTransitions.onSceneHidden = function ()
{
    ...
    if(this.callback != null)
        this.callback(this.hiddenScene);
};
...
ScenesTransitions.showSceneScale = function(scene, delay, transitionLength, callback, transitionEffect, scale)
{
    ...
    if (transitionLength === undefined) transitionLength = ScenesTransitions.TRANSITION_LENGTH / 2;
    if (callback === undefined) callback = null;
    if (transitionEffect === undefined) transitionEffect = ScenesTransitions.TRANSITION_EFFECT_IN;
